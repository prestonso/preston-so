...
const IndexPage = ({ data }) => (
  <Layout>
    ...
    <Card
      ...
      body={<p>I write, speak, and work on the intersections of <strong>content, design, and code</strong> and lead <strong>product, design, engineering, and developer relations</strong> teams.</p>}
    />
    <Card
      type="dark-magenta"
      orientation="left"
      ...
      body={<p>Today’s content needs to leap off devices and into the physical spaces we live and work in. Reach the final frontier of content design with my newest book <a href="https://abookapart.com/products/immersive-content-and-usability" rel="noopener noreferrer" target="_blank"><em>Immersive Content and Usability</em></a>. <a href="https://abookapart.com/products/immersive-content-and-usability" rel="noopener noreferrer" target="_blank" className="call-to-action--link">Buy now</a></p>}
    ...
    <Card
      ...
      titleLink="/books"
      body={<p>I’m an <a href="https://alistapart.com/author/preston-so/" target="_blank" rel="noopener noreferrer"><em>A List Apart</em></a> editor, <a href="https://www.cmswire.com/author/preston-so/" target="_blank" rel="noopener noreferrer"><em>CMSWire</em></a> columnist, and <a href="https://www.smashingmagazine.com/author/preston-so/" target="_blank" rel="noopener noreferrer"><em>Smashing Magazine</em></a> contributor. I also wrote the definitive books about <Link to="/books/immersive-content">immersive content</Link>, <Link to="/books/voice-content">voice content</Link>, <Link to="/books/gatsby">Gatsby</Link>, and <Link to="/books/decoupled-drupal">decoupled Drupal</Link>. <Link to="/writing" className="call-to-action--link">Read my articles</Link></p>}
      listing={
        <>
