...
const AboutPage = () => (
  <Layout>
    ...
    <Card
      ...
      orientation="no"
      title="About"
      body={<p>Preston is a <strong>product strategist</strong>, <strong>digital experience futurist</strong>, <strong>innovation lead</strong>, and <strong>developer advocate</strong>.</p>}
    />
    <Card
      type="main"
      orientation="no"
