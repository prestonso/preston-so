...
const AboutPage = () => (
  <Layout>
    ...
    <Card
      ...
      body={
        <>
          <p>Preston So is a product architect and strategist, digital experience futurist, innovation lead, developer advocate, three-time SXSW speaker, and author of <a href="https://www.amazon.com/Decoupled-Drupal-Practice-Architect-Architectures/dp/1484240715/ref=sr_1_1" target="_blank" rel="noopener noreferrer"><em>Decoupled Drupal in Practice</em></a> (Apress, 2018). He is an <em>A List Apart</em> contributor named “probably the smartest person working in this industry right now” by <a href="https://www.amazon.com/_/dp/1491908122"><em>Web Content Management</em></a> author <a href="https://gadgetopia.com/">Deane Barker</a> in 2020.</p>
          <p>A globally recognized subject matter expert on headless content management systems (CMS), decoupled Drupal, conversational design, and the decentralized web, Preston is Senior Director, Product Strategy at <a href="https://oracle.com" target="_blank" rel="noopener noreferrer">Oracle</a>Oracle, where he oversees developer experience and developer relations for Oracle Content and Experience (OCE). He is also Editor in Chief at <a href="https://tag1consulting.com" target="_blank" rel="noopener noreferrer">Tag1 Consulting</a>, where he directs thought leadership and hosts <em>Tag1 Team Talks</em>, a webinar series about emerging web technologies, and <em>Core Confidential</em>, the insider guide to Drupal core.</p>
