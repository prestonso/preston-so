...
const AboutPage = () => (
  <Layout>
    ...
    <Card
      ...
      orientation="no"
      title="About"
      body={<p>Preston is a <strong>product strategist</strong>, <strong>innovation lead</strong>, and <strong>developer advocate</strong>.</p>}
    />
    <Card
      type="main"
      orientation="no"
      ...
      body={
        <>
          ...
          <p>A three-time speaker at SXSW Interactive (<a href="http://schedule.sxsw.com/2017/events/PP61872" target="_blank" rel="noopener noreferrer">2017</a>, <a href="http://schedule.sxsw.com/2017/events/PP97035" target="_blank" rel="noopener noreferrer">2017 encore</a>, <a href="http://schedule.sxsw.com/2018/events/PP74569" target="_blank" rel="noopener nofollower">2018</a>), Preston is a sought-after presenter on topics such as user experience, web development, open-source innovation, and emerging technologies. The 50+ events where Preston has spoken include keynotes on five continents and in three languages.</p>
          <p>Prior to Gatsby, Preston was Director of Research and Innovation at <a href="https://acquia.com" target="_blank" rel="noopener noreferrer">Acquia</a>, where he helmed <a href="https://acquia.com/resources/acquia-labs" target="_blank" rel="noopener noreferrer">Acquia Labs</a>, an innovation center architecting groundbreaking projects for clients like the <a href="https://www.acquia.com/blog/ask-georgiagov-alexa-skill-citizens-georgia-acquia-labs/12/10/2017/3312516" target="_blank" rel="noopener noreferrer">State of Georgia</a> and <a href="https://www.acquia.com/blog/voice-enabled-search-action-nestle-purina-and-acquia-labs" target="_blank" rel="noopener nofollower">Nestlé Purina</a>, and created <em>Experience Express</em>, a travel-inspired column about building and designing digital experiences.</p>
          <p>Previously, Preston oversaw the <a href="https://www.ew.com" target="_blank" rel="noopener noreferrer"><em>Entertainment Weekly</em></a> website and managed its development team at Time Inc. (now Meredith), contributed to the <a href="https://www.drupal.org/project/spark" target="_blank" rel="noopener nofollower">Spark</a> initiative in the Drupal project, and operated an award-winning freelance web and print design studio. Preston also directed the most recent redesign of <a href="https://thecrimson.com" target="_blank" rel="noopener nofollower"><em>The Harvard Crimson</em></a>’s online edition, the first student-designed responsive newspaper site in the Ivy League.</p>
          <p>Preston has also given free web development classes in public libraries, co-founded the <a href="https://groups.drupal.org/southern-colorado-scug" target="_blank" rel="noopener nofollower">Southern Colorado Drupal User Group</a> (est. 2008), and is lead organizer and co-founder of <a href="https://decoupleddays.com" target="_blank" rel="noopener nofollower">Decoupled Days</a>, a conference about the future of content management systems and their architectures.</p>
        </>
      }
    />
  </Layout>
