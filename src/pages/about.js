    ...
    <Card
      ...
      body={
        <>
          ...
          <p><strong>Preston So</strong> (he/him) is a digital architect and strategist, product and innovation leader, designer and developer advocate, multilingual educator and speaker, and author of <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018).</p>
          <p>Preston has been a programmer since 1999, a web developer and designer since 2001, a creative professional since 2004, a CMS architect since 2007, and a conversational and immersive designer since 2016. Since 2015, he has led product, design, engineering, and innovation teams at organizations like Acquia, Time Inc., and Gatsby.</p>
          <p>A globally recognized subject matter expert on omnichannel content strategy, immersive and conversational design, and modern digital experiences, Preston is Senior Director, Product Strategy at Oracle, where he oversees developer experience, developer relations, headless CMS strategy, and open-source strategy as a product leader for Oracle Content Management.</p>
          ...
          <h3>Short bio</h3>
          <p><strong>Preston So</strong> (he/him) is a digital architect and strategist, product and innovation leader, designer and developer advocate, multilingual educator and speaker, and author of <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018). He has been a programmer since 1999, a web developer and designer since 2001, a creative professional since 2004, a CMS architect since 2007, and a conversational and immersive designer since 2016.</p>
