...
const AboutPage = () => (
  <Layout>
    ...
    <Card
      ...
      body={
        <>
          <p><strong>Preston So</strong> (he/him) is a product architect and strategist, digital experience futurist, innovation lead, developer advocate, three-time SXSW speaker, and author of <em>Voice Content and Usability</em> (A Book Apart, 2021), <a href="https://www.oreilly.com/library/view/gatsby-the-definitive/9781492087502/" target="_blank" rel="noopener noreferrer"><em>Gatsby: The Definitive Guide</em></a> (O'Reilly, 2021), and <a href="https://www.apress.com/gp/book/9781484240717" target="_blank" rel="noopener noreferrer"><em>Decoupled Drupal in Practice</em></a> (Apress, 2018).</p>
