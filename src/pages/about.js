    ...
    <Card
      ...
      body={
        <>
          ...
          <p><strong>Preston So</strong> (he/they) is a product, design, engineering, and innovation leader, digital architect and strategist, designer and developer advocate, multilingual educator and speaker, and author of <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018).</p>
          ...
          <p>A globally recognized authority on the intersections of content, design, and development, Preston is Senior Director, Product Strategy at Oracle, where he oversees developer experience, developer relations, headless CMS strategy, and open-source strategy as a product leader for Oracle Content Management.</p>
