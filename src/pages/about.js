...
const AboutPage = () => (
  <Layout>
    ...
    <Card
      ...
      orientation="no"
      title="About"
      body={<p>Preston is a <strong>digital architect and strategist</strong>, <strong>product and innovation leader</strong>, <strong>design and developer advocate</strong>, <strong>multilingual educator</strong>, and <strong>book author</strong>.</p>}
    />
    <Card
      type="main"
      orientation="no"
      ...
      body={
        <>
          <blockquote>
            ...
            <cite><a href="https://gadgetopia.com/" target="_blank" rel="noopener noreferrer">Deane Barker</a>, author of <em>Web Content Management</em></cite>
          </blockquote>
          <p><strong>Preston So</strong> (he/him) is a digital architect and strategist, product and innovation leader, designer and developer advocate, multilingual educator, and author of <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018).</p>
          <p>Preston has been a programmer since 1999, a web developer and designer since 2001, a creative professional since 2004, a CMS architect since 2007, and a conversational designer since 2016. Since 2015, he has led product, design, engineering, and innovation teams at organizations like Acquia, Time Inc., and Gatsby.</p>
          <p>A globally recognized subject matter expert on omnichannel content strategy, immersive and conversational design, and modern digital experiences, Preston is Senior Director, Product Strategy at Oracle, where he oversees developer experience, developer relations, headless CMS strategy, and open-source strategy for Oracle Content Management.</p>
          ...
          <h3>Short bio</h3>
          <p><strong>Preston So</strong> (he/him) is a digital architect and strategist, product and innovation leader, designer and developer advocate, multilingual educator, and author of <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018). He has been a programmer since 1999, a web developer and designer since 2001, a creative professional since 2004, a CMS architect since 2007, and a conversational designer since 2016.</p>
          <p>A product leader at Oracle, Preston has led product, design, engineering, and innovation teams since 2015 at Acquia, Time Inc., and Gatsby. Preston is an editor at <a href="https://alistapart.com/author/preston-so/" target="_blank" rel="noopener noreferrer"><em>A List Apart</em></a>, a columnist at <a href="https://www.cmswire.com/author/preston-so/" target="_blank" rel="noopener noreferrer"><em>CMSWire</em></a>, and a contributor to <a href="https://www.smashingmagazine.com/author/preston-so/" target="_blank" rel="noopener noreferrer"><em>Smashing Magazine</em></a> and has <Link to="/speaking">delivered keynotes</Link> around the world in three languages. He is based in New York City, where he can often be found immersing himself in languages that are endangered or underserved.</p>
