    ...
    <Card
      ...
      body={
        <>
          ...
          <p>A globally recognized voice on headless content management systems (CMS) and decoupled Drupal, and subject matter expert on conversational design and the decentralized web, Preston is Senior Director, Product Strategy at <a href="https://oracle.com" target="_blank" rel="noopener noreferrer">Oracle</a>, where he leads product strategy for the Oracle Content and Experience Cloud (OCE) developer experience. He is also Editor in Chief at <a href="https://tag1consulting.com" target="_blank" rel="noopener noreferrer">Tag1 Consulting</a>, where he directs content marketing and hosts <em>Tag1 Team Talks</em>, a webinar and podcast series about emerging web technologies.</p>
          ...
          <p><em>"A must-have guide to decoupling Drupal. ... When you finish reading, I think you will agree that decoupled Drupal is an essential element of the bright future in front of Drupal."</em><br />
          —<a href="https://dri.es" target="_blank" rel="noopener noreferrer">Dries Buytaert</a>, Creator and Project Lead of Drupal and Founder and Chairman at Acquia</p>
          <p><em>"This is a really great book. I've been reading blog posts by Preston, hearing him present, and asking him questions on decoupled every chance I can get and I'm so glad to have those thoughts in a physical form I can read through and consult whenever I have questions."</em><br />
          —<a href="https://twitter.com/greggles" target="_blank" rel="noopener noreferrer">Greg Knaddison</a>, Member of the Drupal Security Team and Senior Software and Database Developer at Morris Animal Foundation</p>
          <p><em>"I began to realize that I wanted a little more context and fundamentals that would set up the need, not just the desire, for decoupling. I was looking for a trusted mentor that would help me digest the wide range of terms, tools, and approaches. ... I found Preston’s back-to-basics approach to be very helpful and it provided the context I needed. ... As I move further along in the book, I’m feeling more confident and finding my place in the decoupled conversation."</em><br />
          —<a href="https://twitter.com/andrewozone" target="_blank" rel="noopener noreferrer">Andy Olson</a>, Senior Front-End Developer at <a href="https://www.bounteous.com/insights/2019/02/18/exploring-decoupled-drupal-through-eyes-front-end-themer/" target="_blank" rel="noopener noreferrer">Bounteous</a></p>
          <p><em>"Covers pretty much everything you want to know about decoupled Drupal right now."</em><br />
          —<a href="https://twitter.com/direct" target="_blank" rel="noopener noreferrer">Nick Selvaggio</a>, Director of IT at American Diagnostic</p>
        </>
      }
    />
  </Layout>
