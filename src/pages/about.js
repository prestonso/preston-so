...
const AboutPage = () => (
  <Layout>
    ...
    <Card
      ...
      orientation="no"
      title="About"
      body={<p>Preston is a <strong>digital architect and strategist</strong>, <strong>product and innovation leader</strong>, <strong>developer advocate</strong>, <strong>multilingual educator</strong>, and <strong>author</strong>.</p>}
    />
    <Card
      type="main"
      orientation="no"
