    ...
    <Card
      ...
      body={
        <>
          ...
          <p><strong>Preston So</strong> (he/they) is a product executive with over 21 years of experience in software, 18 years in content technologies, and 10 years overseeing product, design, engineering, and developer relations functions at organizations such as Oracle, Acquia, dotCMS, Time Inc., and Gatsby. He is the author of <Link to="/books/immersive-content"><em>Immersive Content and Usability</em></Link> (A Book Apart, 2023), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018).</p>
          ...
          <p>As Vice President, Product at dotCMS, Preston led the Product and Design organizations in addition to documentation, developer relations, and data engineering functions. He originated the Universal CMS category and concept, deemed “the right idea” by a top-tier analyst and endorsed by industry CEOs, authors, and experts. As Senior Director, Product Strategy at Oracle, he oversaw developer experience, developer relations, developer marketing, headless CMS strategy, and open-source strategy as a product leader for Oracle Content Management.</p>
          ...
          <h3>Short bio</h3>
          <p><strong>Preston So</strong> (he/they) is a product executive with over 21 years in software, 18 years in content technologies, and 10 years leading product, design, engineering, and developer relations functions at organizations such as Oracle, Acquia, dotCMS, Time Inc., and Gatsby. He is the author of <Link to="/books/immersive-content"><em>Immersive Content and Usability</em></Link> (A Book Apart, 2023), <Link to="/books/gatsby"><em>Gatsby: The Definitive Guide</em></Link> (O'Reilly, 2021), <Link to="/books/voice-content"><em>Voice Content and Usability</em></Link> (A Book Apart, 2021), and <Link to="/books/decoupled-drupal"><em>Decoupled Drupal in Practice</em></Link> (Apress, 2018).</p>
