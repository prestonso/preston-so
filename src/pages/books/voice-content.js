...
const VoiceContentPage = () => (
  <Layout>
    ...
    <Card
      ...
      body={<p>Voice content enriches how users interact with our copy, but it also poses vexing questions and dilemmas. Get the answers from A Book Apart’s first voice title, <em>Voice Content and Usability</em>. <a href="https://abookapart.com/products/voice-content-and-usability" rel="noopener noreferrer" className="call-to-action--link">Preorder now</a></p>}
    ...
    <Card
      ...
      body={
        <>
          ...
          <p className="call-to-action--block"><a href="https://abookapart.com/products/voice-content-and-usability" rel="noreferrer noopener" className="call-to-action--link">Preorder now</a></p>
        </>
      }
    />
    <Card
      ...
      body={<p>With a foreword by Erika Hall, <em>Voice Content and Usability</em> equips you to create compelling voice content, situate it in dialogues and flows, and prepare it to go live. <a href="https://abookapart.com/products/voice-content-and-usability" rel="noreferrer noopener" className="call-to-action--link">Preorder now</a></p>}
      listing={
        <>
          <ul>
            <li>
    ...
    <Card
      ...
      body={
        <>
          ...
          <p className="call-to-action--block"><a href="https://abookapart.com/products/voice-content-and-usability" rel="noopener noreferrer" className="call-to-action--link">Preorder now</a></p>
        </>
      }
    />
  </Layout>
